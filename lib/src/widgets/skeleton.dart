...
class _UnitingSkeleton extends _BasicSkeleton {
  ...
  @override
  void paint(SkeletonizerPaintingContext context, Rect paintBounds, Painter paint, textDirection) {
    final unitingContext = UnitingPaintingContext(context.layer, paintBounds, context.config);
...
class _LeafSkeleton extends _BasicSkeleton {
  ...
  @override
  void paint(SkeletonizerPaintingContext context, Rect paintBounds, Painter paint, _) {
